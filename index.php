    ...
    <body>
        <header>
            <div class="header-top">
                <div class="left">
                    <img src="img/img_1.png" alt="google logo">
                </div>
                <div class="right">
                    <i class="fa-solid fa-table-cells"></i>
                    <div class="wrapper-img">
                        <img src="img/img_2.png" alt="profilo">
                    </div>
                </div>
            </div>
            <div class="header-bot">
               <ul>
                    ...
                    <li>Tecnologie</li>
                    <li class="set">Domande frequenti</li>
               </ul>
            </div>
        </header>
        ...
        <main>
            <div class="container-main">
                    <?php
                        foreach($faqArray as $risulato){
                            $domanda = $risulato['domanda'];
                            $risposta = $risulato['risposta'];
                    ?>
                        <h1><?php echo $domanda; ?></h1>

                        <?php 
                            $rispostaEsplosa = explode("..", $risposta);
                            foreach($rispostaEsplosa as $risp){
                        ?>
                            <p><?php echo $risp;  ?></p>
                        <?php
                            }
